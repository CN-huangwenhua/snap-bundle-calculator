        ...
        <CardContent>
          <div className="flex flex-col gap-5">
            <div className="flex items-center justify-center gap-4">
              <Image src="/image/credits.webp" width={40} height={40} alt="golden varient" className="object-contain" />
              <Input type="number" placeholder={t('number_of_variants')} value={gvarient === 0 ? '' : gvarient} onChange={(e) => setGVarient(Number(e.target.value))} />
            </div>
            <div className="flex items-center justify-center gap-4">
